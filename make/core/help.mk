...
CY_HELP_bsp_VERBOSE=This target generates a new Board Support Package with the name provided in TARGET_GEN based on the current\
					...
					define the target device (DEVICE_GEN) and additional devices (ADDITIONAL_DEVICES_GEN) such as radios. For example,\
					$(CY_NEWLINE)$(CY_NEWLINE)make bsp TARGET_GEN=NewBoard DEVICE_GEN=CY8C624ABZI-S2D44 ADDITIONAL_DEVICES_GEN=CYW4343WKUBG
