...
ifeq ($(findstring ewarm8,$(MTB_RECIPE__IDE_SUPPORTED)),)
	...
	$(MTB__NOISE)echo;\
	$(CY_PYTHON_PATH) $(_MTB_CORE__IAR_TEMPLATE_PATH)/iar_export.py -build_data $(_MTB_CORE__IAR_BUILD_DATA_FILE) -recipe_data $(MTB_RECIPE__IDE_RECIPE_DATA_FILE) -o $(MTB_TOOLS__PRJ_DIR)/$(_MTB_CORE__IAR_OUTFILE);\
	rm -rf $(_MTB_CORE__IAR_BUILD_DATA_FILE);\
