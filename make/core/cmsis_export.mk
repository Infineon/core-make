...
ifeq ($(findstring uvision5,$(MTB_RECIPE__IDE_SUPPORTED)),)
	...
	$(MTB__NOISE)echo;\
	$(CY_PYTHON_PATH) $(_MTB_CORE__CMSIS_TEMPLATE_PATH)/cmsis_export.py -build_data $(_MTB_CORE__CMSIS_BUILD_DATA_FILE) -recipe_data $(MTB_RECIPE__IDE_RECIPE_DATA_FILE) -cpdsc $(_MTB_CORE__CMSIS_CPDSC) -gpdsc $(_MTB_CORE__CMSIS_GPDSC) -cprj $(_MTB_CORE__CMSIS_CPRJ);\
	rm -rf $(_MTB_CORE__CMSIS_BUILD_DATA_FILE);\
